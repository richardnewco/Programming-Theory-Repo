...
public class Inheretance : MonoBehaviour
{
    ...
    public virtual void TextBox()
    {
        ...
        textyI.text = "Inheretance was used in the project by having the base class 'Inheritance' inhereting through the other zombie child classes. We also overrided the functions";
    }
